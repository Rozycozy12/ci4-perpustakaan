 <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <body>
  <h2><br /><br /><center>DATA PENGEMBALIAN BUKU PERPUSTAKAAN</center>
  <br>
    ...
    <tbody>
      <?php foreach($pengembalian as $row): ?>
        <tr>
          ...
          <td><center><a href="/pengembalian/delete/<?= $row->id_kembali ?>" class="btn-submit"><i class = "fa fa-remove"></i></a></td>
        </tr>
      <?php endforeach;?>
    </tbody>
  </table>